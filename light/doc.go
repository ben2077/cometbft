...
https://github.com/ben2077/cometbft/blob/v0.38.x/spec/light-client/verification/README.md
for details.
...
for usage example.
Or see
https://github.com/ben2077/cometbft/tree/v0.38.x/spec/consensus/light-client
for the full spec
*/
package light
